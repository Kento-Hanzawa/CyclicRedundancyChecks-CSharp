...
namespace CyclicRedundancyChecks
{
    ...
    public sealed class CRC16 : CRC
    {
        ...
        private const int MaxBitWidth = sizeof(ushort) * 8;

        private ushort _result;
        private ushort[] _lookupTableBuffer;
        ...
        private ushort BitMask => (BitWidth == MaxBitWidth) ? (ushort)0xFFFF : (ushort)((1UL << BitWidth) - 1);
        private int BitWidthInBytes => sizeof(ushort);

        private ReadOnlySpan<ushort> LookupTable
        {
            get
            {
                if (_lookupTableBuffer is null)
                {
                    _lookupTableBuffer = ArrayPool<ushort>.Shared.Rent(LookupTableSize);
        ...
        /// </param>
        public CRC16(ushort polynomial, ushort initialValue, ushort finalXorValue, bool reflectInput, bool reflectOutput, bool isBigEndian = false, bool useLookupTable = true)
            : this(polynomial, initialValue, finalXorValue, reflectInput, reflectOutput, 16, isBigEndian, useLookupTable) { }

        internal CRC16(ushort polynomial, ushort initialValue, ushort finalXorValue, bool reflectInput, bool reflectOutput, int bitWidth, bool isBigEndian = false, bool useLookupTable = true)
        {
...
#pragma warning disable CS1591
        ...
        protected sealed override bool TryHashFinal(Span<byte> destination, out int bytesWritten)
        {
            ...
            _result = (ushort)(_result & BitMask);
        ...
        protected sealed override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                {
                    ArrayPool<ushort>.Shared.Return(_lookupTableBuffer);
